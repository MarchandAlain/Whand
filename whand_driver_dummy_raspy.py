...
global Boxes
global Boxinputs
Boxes=1                                                                   # overrides whand_parameters for Raspy
Boxinputs=26                                                           # overrides whand_parameters for Raspy
Pins=[]
Outputs=[]
...
##        err=[]
##        for pin in Pins:
##            if pin<2 or pin>26: err+=["pin("+str(pin)+")"]
##        for pin in Outputs:
##            if pin<2 or pin>26: err+=["output("+str(pin)+")"]
##        if err:
##            print(Err_io_number)
##            print(err)
##            raise ReferenceError
