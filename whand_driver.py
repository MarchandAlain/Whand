...
An entry to the following functions is expected, even if the function is not really implemented:
...
# Initialization ============================================
def init_hardware():                                                     # required by Whand         
    """
    Initializes ASi
...
# The following function is not required by Whand but is needed when inputs trigger interrupts
#================================================================
